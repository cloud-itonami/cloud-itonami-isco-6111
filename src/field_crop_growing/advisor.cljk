(ns field-crop-growing.advisor
  "FieldCropAdvisor — proposes a field-crop-growing operation (plant
  step, harvest entry, pesticide/herbicide application near a water
  source, operation near heavy farm machinery) for a registered plot.
  ...
  PROPOSAL — it never writes to the store and has no notion of plot
  provenance or pesticide/machinery risk;
  `field-crop-growing.governor` is the independent system that
  decides whether the proposal may proceed, per the itonami actor
  pattern.

  A proposal is a map:
    {:op :plant|:harvest|:pesticide-application-near-water|:operate-near-heavy-machinery
...
(def ^:private system-prompt
  "You are a field-crop-growing advisor. Given a plant or harvest
